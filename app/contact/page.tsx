  ...
  return (
    <div className="mx-auto max-w-[1200px] pb-[var(--section-y)] md:pb-[var(--section-y-lg)]">
      <PageHeader
        ...
        lead="Tell us what you're working with — your message goes straight to the team, not a ticket queue."
      />

      <div className="grid grid-cols-1 gap-[var(--s-16)] px-[var(--s-6)] lg:grid-cols-[3fr_2fr]">
        ...
        <aside className="order-1 lg:order-2">
          <Reveal>
            <h2 className="text-eyebrow border-t border-rule-strong pt-[var(--s-4)] text-grey-600">
              Direct
            </h2>
