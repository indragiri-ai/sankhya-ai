---
name: design-system-fusemachines
description: Creates implementation-ready design-system guidance with tokens, component behavior, and accessibility standards. Use when creating or updating UI rules, component specifications, or design-system documentation.
---
<!-- TYPEUI_SH_MANAGED_START -->
# Fusemachines
## Mission
Deliver implementation-ready design-system guidance for Fusemachines that can be applied consistently across marketing website interfaces.
...
## Accessibility
- Target: WCAG 2.2 AA
- Keyboard-first interactions required: Ensure every button, link, and form input has keyboard focus outlines and handlers.
- Focus-visible rules required: Outlines must be visible and contrast with background colors.
- Contrast constraints required: Standard text must have a minimum contrast ratio of 4.5:1.
